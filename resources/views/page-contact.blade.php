    ...
    <section class="s-content s-content--top-padding s-content--narrow">
        ...
        <div class="row">
            <div class="col-full s-content__main">
                ...
                <form name="cForm" id="cForm" class="contact-form" method="post" action="{{ url('contact/send') }}">
                    <fieldset>
                        {{ csrf_field()}}
                        ...
                        <button name="submit" type="submit" class="submit btn btn--primary btn--large full-width">Send Message</button>
